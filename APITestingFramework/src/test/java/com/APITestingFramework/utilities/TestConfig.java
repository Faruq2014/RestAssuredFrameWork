package com.APITestingFramework.utilities;
public class TestConfig{


	
	public static String server="smtp.gmail.com";
	public static String from = "javaselenium6@gmail.com";
	public static String password = "Morning@840+VA";
	public static String[] to ={"mofmolla7@gmail.com","mjmolla@gmail.com"};
